  ...
  <div class="home-main-block">
    <div class="home-main container-fluid">
      ...
      <span
        ...
        v-bind:class="{ inviz: !shift }"
        v-on:click="left"
        ><img src="../assets/Mask.svg"
      /></span>
      <div class="row product-slider">
        <Product
          class="col-12 col-lg-4 single-product"
...
export default {
  ...
  methods: {
    right() {
      if (
        this.width > 991 &&
        Math.floor(this.max / 3) > this.shift / -100 + 1
      ) {
        this.shift -= 100;
      } else if (
        this.width > 991 &&
...
.home-main .slider-button-left img,
.home-main .slider-button-right img {
  width: 12px;
}
...
.home-main .slider-button-left:hover,
.home-main .slider-button-right:hover {
  box-shadow: black 0px 0px 35px -13px;
}
.home-main .slider-button-left:active,
.home-main .slider-button-right:active {
